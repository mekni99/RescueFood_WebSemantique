...
@section('content')
    ...
    <main class="main-content  mt-0">
        ...
        <div class="flex flex-col mb-3">
            <input type="text" name="restaurant_name" class="form-control" placeholder="Restaurant Name" aria-label="Restaurant Name" value="{{ old('restaurant_name') }}" >
            @error('restaurant_name') <p class='text-danger text-xs pt-1'> {{ $message }} </p> @enderror
        </div>
        ...
        <!-- Numéro de téléphone -->
        <div class="flex flex-col mb-3">
            <input type="text" name="phone_number" class="form-control" placeholder="Phone Number" aria-label="Phone Number" value="{{ old('phone_number') }}" >
