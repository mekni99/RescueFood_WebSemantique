...
@section('content')
    <main class="main-content  mt-0">
        ...
        style="background-image: url('{{ asset('img/Main2.jpg') }}'); background-position: top;">
                ...
                <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                    <div class="card z-index-0">
                        <div class="card-header text-center pt-4">
                            <h5 style='color: #F96C57; '>Register with</h5>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            @error('role') <p class='text-danger text-xs pt-1'> {{ $message }} </p> @enderror
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn w-100 my-4 mb-2" style="background-color: #8cc342; color:white ;">Sign up</button>
                                </div>
