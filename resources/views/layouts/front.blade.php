...
<section id="header">
    <div class="container">
        <!-- Logo -->
        <h1 id="logo"><a href="{{ url('/') }}">Rescue Food</a></h1>
        <p>Facilitating food recovery and redistribution for a sustainable future.</p>
        ...
        <section id="banner">
            <div class="container">
                <header>
                    <h2>Welcome to <strong>RescueFood</strong>!</h2>
                </header>
                ...
                <div class="row">
                    ...
                    <div id="content" class="col-8 col-12-medium">
                        ...
                        <article class="box post">
                            <header>
                                <h2><a href="#">Our Mission to Combat Food Waste</a></h2>
                            </header>
                            <a href="#" class="image featured"><img src="{{ asset('img/front6.jpg') }}" alt="Food Recovery" /></a>
                            <h3>Join us in making a change!</h3>
                        ...
                        <article class="box post">
                            <header>
                                <h2><a href="#">How You Can Help</a></h2>
                            </header>
