...
<header
    ...
    <div class="grid md:grid-cols-2 items-center gap-4 max-w-6xl w-full">
        ...
        <div class="border border-gray-300 rounded-lg p-6 max-w-md shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] max-md:mx-auto">
            <form action="{{ route('user.destinataires.store') }}" method="POST" class="space-y-4">
                @csrf

                <div class="mb-8">
                    <h3 class="text-gray-800 text-3xl font-extrabold">Ajouter des Destinataires</h3>
                    <p class="text-gray-500 text-sm mt-4 leading-relaxed">Associez les destinataires à une demande existante et ajoutez leurs informations.</p>
                </div>
                ...
                <!-- Select Request -->
                <div>
                    <label for="request_id" class="text-gray-800 text-sm mb-2 block">Associer à une Demande Existante</label>
                    <select class="form-select w-full text-sm text-gray-800 border border-gray-300 px-4 py-3 rounded-lg outline-blue-600" id="request_id" name="request_id" required>
                ...
                <div class="!mt-4">
                    <button type="button" id="add-destinataire" class="w-full shadow-xl py-3 px-4 text-sm tracking-wide rounded-lg  bg-white border "style='color: #8cc342;'>Ajouter un autre destinataire</button>
                </div>

                <!-- Submit Button -->
                <div class="!mt-8">
                    <button type="submit" class="w-full shadow-xl py-3 px-4 text-sm tracking-wide rounded-lg text-white  focus:outline-none" style='background-color: #8cc342;'>Enregistrer les Destinataires</button>
                </div>
            </form>
        </div>
        ...
        <div class="lg:h-[400px] md:h-[300px] max-md:mt-8">
            <img src="{{ asset('img/4.jpg') }}" class="rounded-xl w-full h-full max-md:w-4/5 mx-auto block object-cover" alt="Adding Destinataires" />
        </div>
    </div>
</div>
